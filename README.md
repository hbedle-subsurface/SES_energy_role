...
## The five roles you can be

- **Energy Systems Analyst** — wants to understand how things work from the inside out; drawn to the technical and modeling dimensions of energy
- **Climate Communications Strategist** — translates complexity into public understanding; journalism, PR, English, education majors
- **Energy Strategist** — makes the economics real; business, finance, accounting, economics majors
- **Energy Policy Architect** — understands that governance is the structural challenge; pre-law, political science, public administration, international studies
- **Energy Equity Researcher** — keeps the human dimension in the room; sociology, public health, geography, fine arts, education, psychology

Each result includes a discipline-specific personality description, a trait list, a tailored explanation of what SES offers that student specifically, a scholarship callout, and links to the program.
...
Every result card surfaces the undergraduate scholarship program: up to $1,000, paid incrementally at four milestones ($250 each), no GPA minimum, any major, 20 awards available for 2026–27. Questions to [SES@ou.edu](mailto:SES@ou.edu).
